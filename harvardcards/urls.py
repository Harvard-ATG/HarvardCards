...
urlpatterns = patterns('',
    ...
    url(r'^deck/(?P<deck_id>\d+)/edit-card', 'harvardcards.apps.flash.api.card.create', name='deckEditCard'),
    url(r'^deck/(?P<deck_id>\d+)/render-edit-card', 'harvardcards.apps.flash.views.deck.edit_card', name='renderEditCard'),
