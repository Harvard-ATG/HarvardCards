...
urlpatterns = patterns('',
    ...
    url(r'^deck/(?P<deck_id>\d+)/create-card', 'harvardcards.apps.flash.views.deck.create_card', name='deckCreateCard'),
    url(r'^deck/(?P<deck_id>\d+)/edit-card', 'harvardcards.apps.flash.views.deck.edit_card', name='deckEditCard'),
