define(['jquery', 'views/Slider', 'views/CardForm', 'views/urlManipulate', 'jquery.appendAround', 'jqueryui', 'jquery.mousewheel'], function($, Slider, CardForm, urlManipulate) {
current = 0;
...
$(document).ready(function(){
    ...
    $('#reviewM').click(function(){
        location.href=urlManipulate.addParameter(this.href,'cardLoc',(current+1), false);
        return false;
    });
