...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Canvas_Course'
        db.create_table(u'flash_canvas_course', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('canvas_course_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ...
        db.send_create_signal(u'flash', ['Canvas_Course'])


    def backwards(self, orm):
        # Deleting model 'Canvas_Course'
        db.delete_table(u'flash_canvas_course')
    ...
    models = {
        ...
        u'flash.canvas_course': {
            'Meta': {'ordering': "['canvas_course_id', 'course_name_short', 'course_name']", 'object_name': 'Canvas_Course'},
            'canvas_course_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
