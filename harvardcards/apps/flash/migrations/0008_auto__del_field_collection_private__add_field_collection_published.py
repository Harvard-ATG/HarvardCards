...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'flash_collection', 'private')

        # Adding field 'Collection.published'
        db.add_column(u'flash_collection', 'published',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'flash_collection', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Collection.published'
        db.delete_column(u'flash_collection', 'published')
