...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'flash', ['Course_Map'])
        ...
        db.send_create_signal(u'flash', ['Course'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'flash_canvas_course', (
            ('course_name', self.gf('django.db.models.fields.CharField')(max_length=2048)),
            ('canvas_course_id', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course_name_short', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        ...
        # Deleting model 'Course_Map'
        db.delete_table(u'flash_course_map')

        # Deleting model 'Course'
        db.delete_table(u'flash_course')
